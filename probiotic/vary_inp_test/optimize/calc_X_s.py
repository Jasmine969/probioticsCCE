from Neural_Network.probiotic.gen_bag_model import gen_bag
import numpy as np
import Neural_Network.my_functions as mf
import pickle
import torch
from torch.nn.utils import rnn
from Neural_Network.probiotic. \
...
def calc_x_s(
    ...
    if pred.size - 1 < exp_cond['dur']:
        return x[-1, 2], -0.01  # unreliable trial
    return x[pred.size - 1, 2], pred[-1]
